...
* 思考面向
	* Company-Centric: Strategy is built in align with set goal and policy
	* Customer-Centric: Strategy is build from customers' insights
	* eg. Uber: how to solve the problem from place A to place B
* 
* Before Digital: Competitive Strategy
* After Digital: Experience Strategy